...
class PostLikeControllerTest {
    ...
    void shouldRespondWith401ToAddLikeIfUserUnauthorized() {
        given()
                ...
                .uri()
        .when()
                .post(baseUrl + "/posts/{postId}/like", 1)
        .then()
    ...
    void shouldCreateNewLike() {
        ...
        given()
                ...
                .body(request)
        .when()
                .post(baseUrl + "/posts/{postId}/like", postId)
        .then()
    ...
    void shouldRespondWith401ToUnLikeIfUserUnauthorized() {
        given()
                ...
                .uri()
        .when()
                .delete(baseUrl + "/posts/{postId}/like", 1)
        .then()
                .statusCode(UNAUTHORIZED.value());
    }
    ...
    void shouldUnlikePost() {
        ...
        given()
                ...
                .oauth2(tokenFor("user1"))
        .when()
                .delete(baseUrl + "/posts/{postId}/like", postId)
        .then()
                .statusCode(OK.value())
                .body("totalLikes", equalTo(0))
                .body("totalDislikes", equalTo(0));
    ...
    void shouldRespondWith404IfLikeDoesNotExist() {
        given()
                ...
                .oauth2(tokenFor("user1"))
        .when()
                .get(baseUrl + "/posts/{postId}/like", 1)
        .then()
                .statusCode(NOT_FOUND.value());
    }
    ...
    void shouldGetLikeForPost() {
        ...
        given()
                ...
                .oauth2(tokenFor("user1"))
        .when()
                .get(baseUrl + "/posts/{postId}/like", postId)
        .then()
                .statusCode(OK.value())
