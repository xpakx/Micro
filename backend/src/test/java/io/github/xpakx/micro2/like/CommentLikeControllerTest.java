...
class CommentLikeControllerTest {
    ...
    void shouldRespondWith401ToAddLikeIfUserUnauthorized() {
        given()
                ...
                .uri()
        .when()
                .post(baseUrl + "/user/{username}/comments/{commentId}/like", "user1", 1)
        .then()
    ...
    void shouldCreateNewLike() {
        ...
        given()
                ...
                .body(request)
        .when()
                .post(baseUrl + "/user/{username}/comments/{commentId}/like", "user1", commentId)
        .then()
    ...
    void shouldRespondWith401ToUnLikeIfUserUnauthorized() {
        given()
                ...
                .uri()
        .when()
                .delete(baseUrl + "/user/{username}/comments/{commentId}/like", "user1", 1)
        .then()
                .statusCode(UNAUTHORIZED.value());
    }
    ...
    void shouldUnlikeComment() {
        ...
        given()
                ...
                .oauth2(tokenFor("user1"))
        .when()
                .delete(baseUrl + "/user/{username}/comments/{commentId}/like", "user1", commentId)
        .then()
                .statusCode(OK.value())
                .body("totalLikes", equalTo(0))
                .body("totalDislikes", equalTo(0));
    ...
    void shouldRespondWith404IfLikeDoesNotExist() {
        given()
                ...
                .oauth2(tokenFor("user1"))
        .when()
                .get(baseUrl + "/user/{username}/comments/{commentId}/like", "user1", 1)
        .then()
                .statusCode(NOT_FOUND.value());
    }
    ...
    void shouldGetLikeForComment() {
        ...
        given()
                ...
                .oauth2(tokenFor("user1"))
        .when()
                .get(baseUrl + "/user/{username}/comments/{commentId}/like", "user1", commentId)
        .then()
                .statusCode(OK.value())
